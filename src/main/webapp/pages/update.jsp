...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td width="495">
            ...
            <form action="houseInfoServlet?action=updateHouseInfo" method="post" name="mf" onsubmit="return validateTitle()">
                <input type="hidden" name="fwid" value="${houseInfo.fwid}"/>
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="title" value="${houseInfo.title}"></td>
                    </tr>
                    <tr>
                        <td><strong>区县：</strong></td>
                        <td>
                            <select name="qxid" id="qx">
                                <c:forEach items="${requestScope.districtsList}" var="districts">
                                    <c:if test="${requestScope.street.qxid==districts.qxid}">
                                        <option value="${districts.qxid}" selected="selected">${districts.qx}</option>
                                    </c:if>
                    ...
                    <tr>
                        ...
                        <td><select name="jdid" id="jd">
                            <option value="${requestScope.street.jdid}">${requestScope.street.jd}</option>
                        </select></td>
                    </tr>
                    <tr>
                        <td><strong>租金：</strong></td>
                        <td><input type="text" name="zj" value="${houseInfo.zj}"/>元/月</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><select name="lxid">
                            <c:forEach items="${requestScope.houseTypeList}" var="houseType">
                                <c:if test="${requestScope.houseInfo.lxid==houseType.lxid}">
                                    <option value="${houseType.lxid}" selected="selected">${houseType.fwlx}</option>
                                </c:if>
                                <option value="${houseType.lxid}">${houseType.fwlx}</option>
                            </c:forEach>
                        </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" name="telephone" value="${houseInfo.telephone}"></td>
                    </tr>
                    <tr>
                        <td><strong>联系人：</strong></td>
                        <td><input type="text" name="lxr" value="${houseInfo.lxr}"></td>
                    </tr>
                    <tr>
                        <td><strong>房屋信息：</strong></td>
                        <td><textarea name="fwxx" rows="10" cols="40">${houseInfo.fwxx}</textarea></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div align="center"><input type="submit" value="确认修改" class="btn"></div>
                        </td>
                    </tr>
                </table>
            </form>
