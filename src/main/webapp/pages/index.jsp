...
-->
	...
	<form action="userServlet" method="post" name="myForm" onsubmit="return login()">
	  ...
	  <table align="center">
		...
		<tr>
		  <td><a href="pages/reg.jsp">注册用户</a></td>
		</tr>
	  </table>
   </form>
</td>
	...
	<form action="list.jsp" method="post" name="mf">
...
<table width="88%" cellspacing="0">
				...
				<tr>
					<td><a href='pages/detail.jsp'>出租健翔桥二居室</a></td>
				...
				<tr>
					<td><a href='../pages/detail.jsp'>健翔桥一居出租了</a></td>
					<td align='center' style='height:30px;'>300元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='../pages/detail.jsp'>北大附近招合租</a></td>
					<td align='center' style='height:30px;'>1000元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='../pages/detail.jsp'>出租鼓楼地铁附近/鼓楼西大街/绝好平房!</a></td>
					<td align='center' style='height:30px;'>1500元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='../pages/detail.jsp'>北三环北太平庄蓟门桥蓟门里小区两居</a></td>
				...
				<tr>
					<td><a href='../pages/detail.jsp'>后现代城一居室出租</a></td>
					<td align='center' style='height:30px;'>2400元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='../pages/detail.jsp'>北太平庄房屋出租</a></td>
					<td align='center' style='height:30px;'>1000元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='../pages/detail.jsp'>西便门北二区出租3室1厅</a></td>
					<td align='center' style='height:30px;'>1900元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='../pages/detail.jsp'>便宜出租前门四合院</a></td>
					<td align='center' style='height:30px;'>2500元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='../pages/detail.jsp'>出租2居</a></td>
					<td align='center' style='height:30px;'>2100元</td>
					<td align='center'>2007-07-03</td>
				</tr>
				
				<tr>
					<td><a href='../pages/detail.jsp'>qq的租房信息1</a></td>
					<td align='center' style='height:30px;'>1000元</td>
